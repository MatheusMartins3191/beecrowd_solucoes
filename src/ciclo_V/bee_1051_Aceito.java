/*
    Desafio Bee 1051 : Imposto de Renda.
    ...
    o valor que esta pessoa deve pagar de Imposto de Renda, segundo tabela.
    ...
    Saída:
        ...
        Imprima o texto "R$" seguido de um espaço e do valor total devido de Imposto de Renda, com duas casas após o
    ponto. Se o valor de entrada for menor ou igual a 2000, deverá ser impressa a mensagem "Isento".
...
public class bee_1051_Aceito {
    ...
    public static void main(String[] args) {
        ...
        if (valor >= 2000.01 && valor <= 3000.00) {
            imposto = (valor - 2000.00) * (8.00 / 100);
            System.out.println("R$ " + df.format(imposto));
        }

        if (valor >= 3000.01 && valor <= 4500.00) {
            imposto = ((valor - 3000) * (18.00 / 100)) + (1000.00 * (8.00 / 100));
            System.out.println("R$ " + df.format(imposto));
        }

        if (valor > 4500) {
            imposto = ((valor - 4500.00) * (28.00 / 100)) + (1000.00 * (8.00 / 100)) + (1499.99 * (18.00 / 100));
            System.out.println("R$ " + df.format(imposto));
        }
